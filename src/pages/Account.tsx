            ...
            <Theme appearance={"dark"}>
                <div className="mx-auto">
                        ...
                        <AlertDialog.Root>
                            ...
                            <AlertDialog.Content>
                                ...
                                <Flex gap="3" mt="4" justify="end">
                                    ...
                                    <AlertDialog.Action>
                                        <Button onClick={handleClear} variant="solid" color="red">
                                            Կատարել
                                        </Button>
                                    </AlertDialog.Action>
                                </Flex>
                    ...
                    <div className="flex flex-col items-center mt-6">
                        ...
                        />
                        <h2 className={`mt-4 text-xl font-semibold`}>{userData.first_name} {userData.last_name ? userData.last_name : null}</h2>
                    ...
                    <div className={"grid grid-cols- p-5 mt-5 gap-5"}>
                        {
                            quizzes.map((quiz, i) => (
                                <div key={i}
                                     className={"bg-gray-200 rounded-3xl cursor-pointer h-[200px] overflow-hidden"}
                                    ...
                                    <div className={"w-full h-full p-5 flex flex-col"}
                                        ...
                                        <div className="flex justify-end gap-5 mt-auto">
                                            <Link
                                                ...
                                                >
                                                    Անցնել {quiz.size >= quiz.level ? <FaArrowRight/> :
                                                    <FaCheckCircle/>}
                                                </button>
                                            </Link>
                                            <Link
