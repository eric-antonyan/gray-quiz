            ...
            <div style={{
                ...
                <div className='text-white p-5 bg-black flex justify-between items-center'>
                    ...
                    <div className='flex gap-2 items-center bg-white text-sm p-2 rounded-2xl'>
                        <p className='font-bold text-black'>@eagledev</p>
                        <img src="https://thecyberexpress.com/wp-content/uploads/What-is-a-Hacker.png" className='w-[30px] aspect-square object-cover rounded-full' alt="" />
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <motion.div initial={{ x: 0 }} animate={{ x: -(100 / (questions.length / questionIndex)) + "%" }} transition={{
                        duration: 0.25,
                        type: 'tween'
                    }} className='flex' style={{ width: questions.length * 100 + "%" }}>
                        {
                            questions.map(({ correct, answers, task }, i) => (
                                <motion.div
                                    key={i}
                                    transition={{ type: "spring", stiffness: 300, damping: 30 }} className='flex flex-col h-screen p-5 flex-1'>
